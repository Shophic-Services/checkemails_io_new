 ...
 (function ($) {
    ...
    HighlightWithinTextarea.prototype = {
      ...
      renderAside: function (boundaries) {
        ...
        table += "<li class='list-group-item d-flex justify-content-between align-items-center'>Word Count <span class='badge badge-info font-size-14'>" + totalWords + "</span></li>";
