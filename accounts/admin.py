...
from accounts.helper import is_user_logged_in
...
class UserAdmin(CheckEmailsBaseModelAdmin):
    ...
    list_display = ( 'email', 'first_name', 'last_name', 'is_active','is_logged_in','action_button')
    ...
    def save_model(self, request, obj, form, change):
        ...
        """
        obj.is_staff = True
        if obj and obj.user_role and obj.user_role.role in [UserRole.CLIENT, UserRole.TEAM, UserRole.MANAGER]:
            obj.is_staff = False
...
class ClientAdmin(UserAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj: 
            if obj.socialaccount_set.all():
                return self.readonly_fields + ('email','get_plan_name')
            return self.readonly_fields + ('get_plan_name',)
        else:
    ...
    def get_impersonate(self, obj):
        _ = self
        if obj.is_active:
            return format_html('''<a class="loginlink" href="/impersonate/stop/?next=/impersonate/{}/"><svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M7 7C7 4.23858 9.23858 2 12 2C14.7614 2 17 4.23858 17 7V9C17 9.55228 16.5523 10 16 10H8C7.44772 10 7 9.55228 7 9V7ZM12 4C10.3431 4 9 5.34315 9 7V8H15V7C15 5.34315 13.6569 4 12 4Z" fill="#152C70"/>
